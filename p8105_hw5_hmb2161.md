...
```
    ...
    ##    <int> <chr>          <dbl>   <dbl>
    ##  1     0 (Intercept)   6.37    0.583 
    ##  2     0 x             2.09    0.798 
    ##  3     0 (Intercept)   7.62    0.552 
    ##  4     0 x             0.0458  0.996 
    ##  5     0 (Intercept)  24.1     0.0500
    ##  6     0 x           -15.2     0.155 
    ##  7     0 (Intercept)  -6.47    0.630 
    ##  8     0 x            -3.21    0.718 
    ##  9     0 (Intercept)  12.6     0.387 
    ## 10     0 x            -3.64    0.730 
...
rejected increases, so the power increases.
...
<img src="p8105_hw5_hmb2161_files/figure-gfm/unnamed-chunk-6-2.png" width="90%" />
